...
7. You'll may be asked to enter your Github account for authentication
...
10. Let's make some changes to the default YAML file.
10.1. Change the VM image to
```
pool:
  vmImage: 'windows-latest'
```
10.2. Add a variables section
```
variables:
...
Your YAML file should now look like ![pipeline](https://github.com/aslotte/mldotnet-real-time-data-streaming-workshop/blob/master/instructions/images/azure-devops-pipeline.PNG)

11. In the top-right corner, click **Run**
